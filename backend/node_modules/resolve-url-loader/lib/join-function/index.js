...
const { createDebugLogger, formatJoinMessage } = require('resolve-url-loader/lib/join-function/debug');
const fsUtils = require('resolve-url-loader/lib/join-function/fs-utils');
